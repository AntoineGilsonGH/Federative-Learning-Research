...
class ByzFLSimulation:
    ...
    def _prepare_data(self):
        ...
        self.data_distributor = DataDistributor({
            "data_distribution_name": self.data_distribution_config.get("distribution_name", "iid"),
            "distribution_parameter": self.data_distribution_config.get("distribution_parameter", 0.5),
    ...
    def _setup_clients(self):
        ...
        base_client_config = {
            ...
            "store_per_client_metrics": self.client_config.get("store_per_client_metrics", True),
        }
    ...
    def _setup_server(self, aggregator_name: str):
        ...
        pre_agg_list = []
        if self.aggregator_config.get("use_pre_aggregation", True):
    ...
    def _setup_byzantine_client(self):
        ...
        attack_config = {
            "name": self.attack_config.get("attack_name", "SignFlip"),
    ...
    def run_single_aggregator(
        ...
        accuracy_history = train(server, self.num_rounds, self.honest_clients, byz_client)
    ...
    def save_results(self, save_path: str = None):
        ...
        results_dict = {
            ...
            "final_accuracies": {
                name: acc[-1] for name, acc in self.results.items()
            },
            "best_accuracies": {
                name: max(acc) for name, acc in self.results.items()
            },
        }
